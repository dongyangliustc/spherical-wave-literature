...
> ⚠️ **时效性提示（2026-09-11 复核）**：本文网络检索截至 2026-07-20。复核发现 **2026 年 3–8 月新增了"多通道 Dyson 方程（MCDE）"整条方法主线**（4 篇）、时域 EKT（PRL 2026）、相对论 EOM-CC 成型，且 **nD-ADC(3) 的可靠性被 2026-08 基准质疑**。
> 请配合阅读：**`outputs/Dyson轨道获取方法_分类与排序_2026-09-11.md`**（时效性补丁 + 双维排序重构）。
> 本文的五视角 STORM 拆解、程序生态细节、决策树仍然有效。
